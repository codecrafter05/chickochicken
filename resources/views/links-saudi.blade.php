  ...
  <div class="links-page" id="linksPageSaudi">
    <div class="links-container">
      ...
      <div class="social-icons">
        ...
        <a href="https://www.tiktok.com/@chickochicken.bh" target="_blank" class="social-icon" aria-label="TikTok">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Contact Number -->
      <div class="contact-section">
        <a href="tel:+966501234567" class="contact-item" aria-label="Call Saudi branch">
