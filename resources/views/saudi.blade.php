...
<head>
  ...
  <title>منيو السعودية — Chicko Chicken</title>
...
<body>
  <div class="sa-menu" role="main">
    ...
    <img src="{{ asset('assets/images/sa/Salad.jpg') }}" alt="" loading="lazy" decoding="async" />
    <img src="{{ asset('assets/images/sa/Sauces.png') }}" alt="" loading="lazy" decoding="async" />
    <img src="{{ asset('assets/images/sa/Drinks.jpg') }}" alt="" loading="lazy" decoding="async" />
  </div>
</body>
</html>
